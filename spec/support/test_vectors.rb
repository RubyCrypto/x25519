...
VariableBaseTestVector = Struct.new(:scalar, :input_coord, :output_coord)

# X25519 variable-base test vectors from RFC 7748
X25519_VARIABLE_BASE_TEST_VECTORS = [
  VariableBaseTestVector.new(
...
FixedBaseTestVector = Struct.new(:scalar, :output_coord)

# X25519 fixed-base test vectors, generated via RbNaCl/libsodium
X25519_FIXED_BASE_TEST_VECTORS = [
  FixedBaseTestVector.new(
    "a546e36bf0527c9d3b16154b82465edd62144c0ac1fc5a18506a2244ba449ac4",
